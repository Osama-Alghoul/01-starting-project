...
export default function HomePage() {
  return (
    <div id="home">
      ...
      <h1>NextNews Site For The Next Generation</h1>
      <p>
        Next News is here to feliver you all the latest news - concise &
        unbiased!
      </p>

      <p>
        NextNews aims to provide you with the latest news in concise and
        unbaised manner. We strive to deliver the news in a way that is easy to
